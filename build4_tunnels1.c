...
/*   Updated: 2018/05/13 20:37:56 by mpascaud         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "lem-in.h"

void	ft_malloc_tunnels(t_roomlist *roomlist,
		t_filist *filist, int *tunnbr, t_filist *filistart)
{
	while (roomlist != NULL)
	{
		while (filist != NULL)
...
void	ft_link_tunnels(int *i, t_roomlist *roomlist,
		t_filist *filist, t_filist *filistart)
{
	*i = 0;
	while (roomlist != NULL)
	{
...
void	ft_malloc_beftunnels(t_roomlist *roomlist, t_filist *filist,
		t_roomlist *roomlistart, t_filist *filistart)
{
	int		tunnbr;
...
void	ft_link_beftunnels(int *i, t_roomlist *roomlist,
		t_filist *filist, t_filist *filistart)
{
	*i = 0;
	filist = filistart;
